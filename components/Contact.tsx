        ...
        <section id="contact" className="min-h-screen flex items-center py-20">
            <div className="container mx-auto px-6">
                    ...
                    <div className="space-y-8">
                        <div className="card">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-pink-500 to-red-600 flex items-center justify-center flex-shrink-0">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-800">
                                ...
                                <div className="flex gap-4">
                                    <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center hover:border-indigo-500 transition-all">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 bg-gray-900/50 border border-gray-800 rounded-lg focus:outline-none focus:border-indigo-500 transition-colors"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={5}
                                    className="w-full px-4 py-3 bg-gray-900/50 border border-gray-800 rounded-lg focus:outline-none focus:border-indigo-500 transition-colors resize-none"
                ...
                <div className="mt-20 pt-8 border-t border-gray-800 text-center text-gray-400">
                    <p>&copy; 2026 Atharva Sharma. All rights reserved.</p>
                </div>
            </div>
        </section>
    );
